...
<div class="row">
	<div class="col-md-12">		
		...
		<a href="#" class="export btn btn-info glyphicon glyphicon-export">Export</a>
			<div id = "dvData">
...
@section('after-scripts-end')
	...
	{!! HTML::script('js/frontend/person/version1/export_csv.js') !!}
	{!! HTML::script('js/frontend/person/version1/add.js') !!}
	{!! HTML::script('js/frontend/person/version1/manage.js') !!}
	{!! HTML::script('js/frontend/person/version1/main.js') !!}
	{!! HTML::script('js/frontend/person/version1/search.js') !!}
@stop
