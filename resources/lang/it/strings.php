...
return [
    ...
    */
    ...
    'see_all' => [
        'messages' => 'Angalia meseji zote',
        'notifications' => 'Angalia zote',
        'tasks' => 'Angalia kazi zote',
    ],
    'sorry_page_you_were_trying' => 'Samahani, kurasa unayohitajia haipo.',
    'test' => 'Test',
    'using_access_helper' => [
        'array_permissions' => 'Tumia Access Helper na Mjumuiko wa Majina ya Ruhusa au ID\'s where the user does have to possess all.',
        'array_permissions_not' => 'Tumia Access Helper na Mjumuiko wa Majina ya Ruhusa au ID\'s where the user does not have to possess all.',
    ...
    'you_can_see_because' => 'Unaiona hii kwa sababu unajukumu la \':role\'!',
    'you_can_see_because_permission' => 'Unaiona hii kwa sababu unaruhusa ya \':permission\'!',
    'you_have' => [
